...
annotate service.Travel with {
    to_Agency @Common.Label : 'to_Agency_AgencyID'
};
annotate service.Travel with {
    to_Customer @Common.Label : 'to_Customer_CustomerID'
};
annotate service.Travel with {
    TravelStatus @Common.Label : 'TravelStatus_code'
};
annotate service.Travel with {
    TravelID @Common.Label : 'TravelID'
};
annotate service.Travel with @(
    UI.HeaderFacets : [
        {
            ...
            Target : '@UI.FieldGroup#i18nTravelDetails',
        },
    ],
